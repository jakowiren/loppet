    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700">
      ...
      <section className="relative py-20 px-4 overflow-hidden min-h-[80vh] flex items-center">
        ...
        <div className="absolute inset-0 z-0">
          {/* Sports equipment video background - MOV files need to be converted to MP4 for web compatibility */}
          <video
            autoPlay
            loop
            muted
          ...
          >
            {/* Convert your background.mov to background.mp4 for better web compatibility */}
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/80 via-blue-800/70 to-blue-700/80 z-20"></div>
        ...
        <div className="relative z-20 max-w-6xl mx-auto text-center">
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link to="/annonser">
                <Button size="lg" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 text-lg font-semibold transition-all duration-200">
            ...
            {/* Small text with bouncing arrow - now below buttons */}
